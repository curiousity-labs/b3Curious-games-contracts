...
export interface ConnectFourSFactoryInterface extends utils.Interface {
  functions: {
...
export interface ConnectFourSFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectFourSFactoryInterface;
