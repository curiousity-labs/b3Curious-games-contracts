...
import type {
  ConnectFourSFactory,
  ConnectFourSFactoryInterface,
} from "../ConnectFourSFactory";
...
type ConnectFourSFactoryConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ConnectFourSFactoryConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ConnectFourSFactory__factory extends ContractFactory {
  constructor(...args: ConnectFourSFactoryConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<ConnectFourSFactory> {
    return super.deploy(
      implAddress,
      overrides || {}
    ) as Promise<ConnectFourSFactory>;
  }
  ...
  override attach(address: string): ConnectFourSFactory {
    return super.attach(address) as ConnectFourSFactory;
  }
  override connect(signer: Signer): ConnectFourSFactory__factory {
    return super.connect(signer) as ConnectFourSFactory__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ConnectFourSFactoryInterface {
    return new utils.Interface(_abi) as ConnectFourSFactoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ConnectFourSFactory {
    return new Contract(address, _abi, signerOrProvider) as ConnectFourSFactory;
  }
}
